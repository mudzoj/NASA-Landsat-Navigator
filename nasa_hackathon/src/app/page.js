...
import { AppBar, Toolbar, Typography, Button, Container, IconButton, Menu, MenuItem, Box, ThemeProvider } from '@mui/material';
  ...
  return (
    <ParticlesBackground>
      <ThemeProvider theme={theme}> {/* Wrap with ThemeProvider */}
        <div style={{ position: 'relative', backgroundColor: 'transparent', minHeight: '100vh', color: 'white' }}>
